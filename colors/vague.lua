...
hl('FloatBorder', { fg = c.float_border, bg = c.background })
hl('FloatFooter', { fg = c.float_border, bg = c.background })
hl('FloatTitle', { fg = c.float_border, bg = c.background })
...
hl('PmenuBorder', { fg = c.float_border })
...
hl('WinSeparator', { fg = c.float_border })
